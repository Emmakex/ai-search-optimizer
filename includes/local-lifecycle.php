...
function kairoseth_aiwr_local_render_lifecycle_page() {
    ...
    <div class="wrap ai-search-optimizer-lifecycle">
        ...
        <?php if ($saved) : ?><div class="notice notice-success inline"><p><?php echo esc_html(kairoseth_aiwr_local_lifecycle_text('saved')); ?></p></div><?php endif; ?>
        <?php if ($nonce_error) : ?><div class="notice notice-error inline"><p><?php echo esc_html(kairoseth_aiwr_local_lifecycle_text('invalid_nonce')); ?></p></div><?php endif; ?>
        <form method="post">
